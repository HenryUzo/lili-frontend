  ...
  return (
    <div className=" h-full relative   w-full flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden block relative">
        <img
          src={images.cuteCatandDogMobile}
          alt=""
          className="w-full"
        />

        <div className="absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center flex-col items-center">
    ...
    leading-[15px]
    tracking-[2px]
    uppercase text-[#62181899]">For Emergency and enquires</span>
          </div>
          <a
...
export const PhoneIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    ...
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.74a16 16 0 0 0 7.34 7.34l1.1-1.84a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
  </svg>
);
